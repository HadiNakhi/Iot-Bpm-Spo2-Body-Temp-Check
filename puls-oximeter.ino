...
void loop() {
  ...
  if (millis() - tsLastReport > REPORTING_PERIOD_MS) 
  {
    ...
    int x = ThingSpeak.writeField(myChannelNumber, 1, BPM, WRITE_API);
    int y = ThingSpeak.writeField(myChannelNumber, 2, SpO2, WRITE_API);
    int z = ThingSpeak.writeField(myChannelNumber, 3,bodytemperature , WRITE_API);
     /*if(x == 200){
